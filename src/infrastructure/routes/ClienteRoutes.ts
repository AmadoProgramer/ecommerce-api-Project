...
router.post   ("/login",                    async (req, res) => {await clienteController.login(req, res)});
router.post   ('/register',                 async (req, res) => {await clienteController.createCliente(req, res);});
router.get    ('/',                         async (req, res) => {await clienteController.getAllClientes(req, res)});
